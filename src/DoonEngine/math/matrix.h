...
float mat3_det(DNmat3 m);
//Returns the inverse of a 3x3 matrix
DNmat3 mat3_inv(DNmat3 m);
...
float mat4_det(DNmat4 m);
//Returns the inverse of a 4x4 matrix
DNmat4 mat4_inv(DNmat4 m);
...
DNmat4 mat4_perspective_proj(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near, GLfloat far);
//Returns a perspective projection matrix from an fov, aspect ratio, and near and far clip planes
DNmat4 mat4_perspective_proj_from_fov(GLfloat fov, GLfloat aspect, GLfloat near, GLfloat far);
